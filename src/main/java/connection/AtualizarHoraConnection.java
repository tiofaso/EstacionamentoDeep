...
public class AtualizarHoraConnection {
    ...
    public void atualizaTicket(int db, int id){
        ...
        //Atualizando base
        sql = "UPDATE tb_estacionamento SET valorpago = '"+ valorAtualizado +"' AND "+
        ...
        try{
            ...
            System.out.println("Não foi possível atualizar o tickert na base de dados. Veja o motivo a seguir:");
